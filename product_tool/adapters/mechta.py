"""Mechta trusted fallback adapter for LG full SKU confirmation."""
...
KNOWN_LG_URLS = {
    "S3WER.ALWPCOM": "https://www.mechta.kz/product/parovoy-shkaf-lg-s3-wer/",
}
    ...
    def find_source(self, full_sku: str, *, deadline: float) -> SourceDocument:
        ...
        if not url:
            return SourceDocument(
                ...
                evidence="Для полного артикула нет ограниченного кандидата Mechta.",
            )
        try:
